...
TEST(Hashtable, AddOneRemoveOne) {
    ...
    *value_ptr = 1; // Assign the integer value 1 to the allocated memory
    kv.value = value_ptr;
    ...
    // HTKeyValue junk;
    // uint64_t key_to_remove = 1;
    // int remove_result = RemoveFromHashtable(ht, key_to_remove, &junk);
